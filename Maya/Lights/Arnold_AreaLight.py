...
# create_arnold_area_light(EXAMPLE["file_path"], EXAMPLE["light_name"])
# -------------------------------------------------------------------------------

def create_arnold_area_light(file_path, light_name="aiAreaLight"):
    """Creates an Arnold aiAreaLight and connects a texture to its color input."""
